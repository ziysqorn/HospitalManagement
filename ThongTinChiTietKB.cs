...
{
	public partial class ThongTinChiTietKB : BaseForm
	{
		...
		public ThongTinChiTietKB(int ctkbID, int patient, string username, string password, Role role, frmMedicalExaminationDetails cTKB)
		{
			InitializeComponent();
			selectedCTKB = ctkbID;
		...
		private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (tabControl1.SelectedIndex == 1)
			{
				...
				{
					MessageBox.Show("Bạn không được quyền xem phần này !", "Thông báo");
					tabControl1.SelectedIndex = 0;
				}
			}
		}
